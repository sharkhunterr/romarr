"""Module-local fixtures for indexer API tests."""
...
def _patch_secret(monkeypatch: pytest.MonkeyPatch) -> Any:
    """Every indexer-API test needs a stable encryption key (used by
    api_key + prowlarr_api_key Fernet encrypt/decrypt)."""
