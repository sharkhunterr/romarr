 ...
 * a sub-page. Shows a compact welcome panel + sections
 * pointing at the currently-shipped sub-pages — Tags + UI
 * are live; the rest land in upcoming slices.
 */
  ...
  return (
    <div className="space-y-6">
      <section className="rounded-lg border border-zinc-800 bg-zinc-900/40 p-5">
        ...
        <p className="mt-2 text-sm text-zinc-400">{t("home.welcomeBody")}</p>
      </section>
